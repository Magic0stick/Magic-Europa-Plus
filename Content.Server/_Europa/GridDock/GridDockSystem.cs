...
public sealed class GridDockSystem : EntitySystem
{
    ...
    {
        SubscribeLocalEvent<GridDockComponent, StationPostInitEvent>(OnStationPostInit);
    }

    private void OnStationPostInit(EntityUid uid, GridDockComponent component, StationPostInitEvent args)
    {
